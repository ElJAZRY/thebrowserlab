...
export function SyntheticDataPanel() {
  ...
  const exportAnnotations = (data: any[], format: 'COCO' | 'PASCAL_VOC' | 'YOLO') => {
    switch (format) {
      case 'COCO':
        return formatAsCOCO(data);
      case 'PASCAL_VOC':
          ...
          <div className="space-y-2 pt-2 border-t border-gray-700/50">
            <label className="flex items-center gap-2">
              <input
                ...
                onChange={(e) => setGenerationSettings({ ...generationSettings, includeBoundingBoxes: e.target.checked })}
                className="rounded border-gray-700 checked:bg-blue-500 checked:border-blue-600"
              />
            ...
            <label className="flex items-center gap-2">
              <input
                ...
                onChange={(e) => setGenerationSettings({ ...generationSettings, includeSegmentationMaps: e.target.checked })}
                className="rounded border-gray-700 checked:bg-blue-500 checked:border-blue-600"
              />
            ...
            <label className="flex items-center gap-2">
              <input
                ...
                onChange={(e) => setGenerationSettings({ ...generationSettings, includeDepthMaps: e.target.checked })}
                className="rounded border-gray-700 checked:bg-blue-500 checked:border-blue-600"
              />
      ...
      <div className="space-y-3 pt-3 border-t border-gray-700/50">
        ...
        {isGenerating ? (
          ...
          <div className="space-y-2">
            ...
            {annotatedObjectsCount > 0 && (
              <p className="text-xs text-center text-gray-400">
                {annotatedObjectsCount} of {totalObjectsCount} objects annotated
              </p>
            )}
          </div>
        )}
